 ...
 * - run on the command line : phpunit UmlParserTest
 * 
 * UmlParserTest compares the objects that PHP_UML_PHP_Parser has generated
 * against the serialized "correct" versions (stored in /providers).
...
class UmlParserTest extends PHPUnit_Framework_TestCase
{
    ...
    static public function providerModelGlobal()
    {
        ...
        $data[] = array($model, $t->model, 'Global parsing');
